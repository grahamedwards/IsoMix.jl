...
@test -239 < loglikelihood(testmodel,testmsmt) < -237
@test -245 < loglikelihood(testmodel, Measurements([-1 0.2; 3 0.2 ; 2 0.2], [2 0.1; 1 0.1; 7 2])) < -243
